...
class DetailBerkasCabangScreen extends StatelessWidget {
  final bool isCabang;
  const DetailBerkasCabangScreen({super.key, this.isCabang = true});
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'Ini adalah teks catatan dummy untuk dokumen LPJ Kader Connect 2026. Laporan pertanggungjawaban kegiatan telah disusun dengan lengkap dan ditandatangani oleh panitia pelaksana.',
                ...
                children: [
                  ...
                  const Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('LPJ_Kader_Connect.pdf', style: TextStyle(fontWeight: FontWeight.bold, color: AppColors.textPrimary)),
                        SizedBox(height: 4),
                        Text('4.1 MB', style: TextStyle(color: AppColors.textSecondary, fontSize: 12)),
                      ],
                    ),
                  ),
                  IconButton(
